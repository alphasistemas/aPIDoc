...
| CATALOGFRONT                                                      | SIGN_IN                         | xxx                                          | XXXX                                                                |   ✖    |     🗸      |    🗸    |
| CATALOGFRONT                                                      | SIGN_IN_SELLER                  | xxx                                          | XXXX                                                                |   ✖    |     🗸      |    🗸    |
| CATALOGFRONT                                                      | SIGN_IN_LEGACY                  | xxx                                          | XXXX                                                                |   ✖    |     🗸      |    🗸    |
| CATALOGFRONT                                                      | SIGN_UP                         | xxx                                          | XXXX                                                                |   ✖    |     🗸      |    🗸    |
| CATALOGFRONT                                                      | CATALOG_CONFIG                  | xxx                                          | XXXX                                                                |   ✖    |     🗸      |    🗸    |
| CATALOGFRONT                                                      | CATALOG_GROUP                   | xxx                                          | XXXX                                                                |   ✖    |     🗸      |    🗸    |
| CATALOGFRONT                                                      | CATALOG_THEME                   | xxx                                          | XXXX                                                                |   ✖    |     🗸      |    🗸    |
| CATALOGFRONT                                                      | CATALOG_PRODUCT                 | xxx                                          | XXXX                                                                |   ✖    |     🗸      |    🗸    |
| CATALOGFRONT                                                      | PRODUCT_PRODUCT                 | xxx                                          | XXXX                                                                |   ✖    |     🗸      |    🗸    |
| CATALOGFRONT                                                      | POSTAL_CODE_ADDRESS             | xxx                                          | viacep.com.br/ws/                                                   |   ✖    |     🗸      |    🗸    |
| CATALOGFRONT                                                      | SALE_ESTIMATE                   | xxx                                          | XXXX                                                                |   ✖    |     🗸      |    🗸    |
| CATALOGFRONT                                                      | SALE_PAYMENT_METHOD             | xxx                                          | XXXX                                                                |   ✖    |     🗸      |    🗸    |
| CATALOGFRONT                                                      | SALE_PAYMENT_CONDITION          | xxx                                          | XXXX                                                                |   ✖    |     🗸      |    🗸    |
| CATALOGFRONT                                                      | PIC_AWS_ACCESS_KEY_ID           | xxx                                          | XXXX                                                                |   ✖    |     🗸      |    🗸    |
| CATALOGFRONT                                                      | PIC_AWS_BUCKET                  | xxx                                          | XXXX                                                                |   ✖    |     🗸      |    🗸    |
| CATALOGFRONT                                                      | PIC_AWS_BUCKET_DIR              | xxx                                          | XXXX                                                                |   ✖    |     🗸      |    🗸    |
| CATALOGFRONT                                                      | PIC_AWS_BUCKET_REGION           | xxx                                          | XXXX                                                                |   ✖    |     🗸      |    🗸    |
| CATALOGFRONT                                                      | ROLE_ID                         | xxx                                          | XXXX                                                                |   ✖    |     🗸      |    🗸    |
