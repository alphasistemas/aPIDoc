...
| ALL BACKEND                                                           | BACK_API_REST_FRAMEWORK           |Framework Rest usado pelo BACKEND                                  | express                                                               |   ✖    |     ✖      |    🗸    |
...
| ALL                                                               | HOST                            | URL BASE DA API                                          | <http://user-alphasystemas.vercel.app/api>                                                                |   ✖    |     🗸      |    🗸    |
...
| BANKING                                                           | USER_HOST                       | Host de usuário                             | <http://api-ecomm.alphasystemas.com.br/user>                       |   🗸    |     🗸      |    🗸    |
...
| CATALOGFRONT                                                      | PIC_AWS_LENGTH                 | QUANTIDADE MÁXIMA DE IMAGENS POR PRODUTO DA AWS                              | 3                                                                   |   ✖    |     ✖      |    🗸    |
| CATALOGFRONT                                                      | PIC_AWS_SIZE                 | TAMANHO MÁXIMO DE IMAGEM                              | 100000                                                                   |   ✖    |     ✖      |    🗸    |
