...
| AUTH                                           | MONGO_DISABLED                  | xxx                                          | true                                                                |   ✖    |     🗸      |    🗸    |                  |
| AUTH                                           | MONGO_WRITE_DISABLED            | xxx                                          | true                                                                |   ✖    |     🗸      |    🗸    |                  |
| AUTH                                           | MONGO_WRITE_URI                 | xxx                                          | true                                                                |   ✖    |     🗸      |    🗸    |                  |
| AUTH                                           | MONGO_WRITE_OPTIONS             | xxx                                          | true                                                                |   ✖    |     🗸      |    🗸    |                  |
| AUTH                                           | MONGO_WRITE_HOST                | xxx                                          | true                                                                |   ✖    |     🗸      |    🗸    |                  |
| AUTH                                           | MONGO_PORT                      | xxx                                          | true                                                                |   ✖    |     🗸      |    🗸    |                  |
| AUTH                                           | MONGO_WRITE_PORT                | xxx                                          | true                                                                |   ✖    |     🗸      |    🗸    |                  |
| AUTH                                           | MONGO_WRITE_USER                | xxx                                          | true                                                                |   ✖    |     🗸      |    🗸    |                  |
| AUTH                                           | MONGO_WRITE_PASSWORD            | xxx                                          | true                                                                |   ✖    |     🗸      |    🗸    |                  |
| AUTH                                           | MONGO_READ_URI                  | xxx                                          | true                                                                |   ✖    |     🗸      |    🗸    |                  |
| AUTH                                           | MONGO_READ_CONNECTION_TYPE      | xxx                                          | true                                                                |   ✖    |     🗸      |    🗸    |                  |
| AUTH                                           | MONGO_READ_OPTIONS              | xxx                                          | true                                                                |   ✖    |     🗸      |    🗸    |                  |
| AUTH                                           | MONGO_READ_HOST                 | xxx                                          | true                                                                |   ✖    |     🗸      |    🗸    |                  |
| AUTH                                           | MONGO_READ_PORT                 | xxx                                          | true                                                                |   ✖    |     🗸      |    🗸    |                  |
| AUTH                                           | MONGO_READ_USER                 | xxx                                          | true                                                                |   ✖    |     🗸      |    🗸    |                  |
| AUTH                                           | MONGO_READ_PASSWORD             | xxx                                          | true                                                                |   ✖    |     🗸      |    🗸    |                  |
| AUTH                                           | LIMIT_WINDOW_MS                 | xxx                                          | true                                                                |   ✖    |     🗸      |    🗸    |                  |
| AUTH                                           | LIMIT_MAX                       | xxx                                          | true                                                                |   ✖    |     🗸      |    🗸    |                  |
| AUTH                                           | MONGO_READ_PASSWORD             | xxx                                          | true                                                                |   ✖    |     🗸      |    🗸    |                  |
